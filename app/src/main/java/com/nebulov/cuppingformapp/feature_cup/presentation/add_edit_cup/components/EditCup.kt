...
fun EditCup(
    ...
    editMessageShown: State<Boolean>,
    shownAddEditScreen: State<Boolean>,
    shownListResult: () -> Unit
            ...
            Scaffold(
                ...
                Column(
                    ...
                    RoastForm(
                        ...
                        onValueChange = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeLevelOfRoast(
                                    it
                                )
                            )
                        },
                    ...
                    VerticalSlider(
                        ...
                        onTextChange = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeNotesFragrance(
                                    it
                                )
                            )
                        },
                    ...
                    VerticalSlider(
                        ...
                        onTextChange = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeNotesAftertaste(
                                    it
                                )
                            )
                        },
                    ...
                    VerticalSlider(
                        ...
                        onValueChange2 = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeLevelOfBody(
                                    it
                                )
                            )
                        },
                    ...
                    CheckBoxForm(
                        ...
                        onTextChange = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeNotesUniformity(
                                    it
                                )
                            )
                        },
                    ...
                    CheckBoxForm(
                        ...
                        onTextChange = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeNotesCleanCup(
                                    it
                                )
                            )
                        },
                        ...
                        onCheckedChange1 = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeCleanCup1(
                                    it
                                )
                            )
                        },
                        onCheckedChange2 = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeCleanCup2(
                                    it
                                )
                            )
                        },
                        onCheckedChange3 = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeCleanCup3(
                                    it
                                )
                            )
                        },
                        onCheckedChange4 = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeCleanCup4(
                                    it
                                )
                            )
                        },
                        onCheckedChange5 = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeCleanCup5(
                                    it
                                )
                            )
                        },
                    ...
                    CheckBoxForm(
                        ...
                        onTextChange = {
                            viewModel.onEvent(
                                AddEditCupEvent.ChangeNotesSweetness(
                                    it
                                )
                            )
                        },
